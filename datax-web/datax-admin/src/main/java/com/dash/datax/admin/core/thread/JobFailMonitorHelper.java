package com.dash.datax.admin.core.thread;
...
import com.dash.datax.admin.core.trigger.TriggerTypeEnum;
...
public class JobFailMonitorHelper {
     ...
     * email alarm template
     */
    private static final String MAIL_BODY_TEMP = "<h5>" + I18nUtil.getString("jobconf_monitor_detail") +
            "：</span>" +
    ...
    private boolean failAlarm(JobInfo info, JobLog jobLog) {
        ...
        if (info != null && info.getAlarmEmail() != null && info.getAlarmEmail().trim().length() > 0) {
            ...
            String content = MessageFormat.format(MAIL_BODY_TEMP,
